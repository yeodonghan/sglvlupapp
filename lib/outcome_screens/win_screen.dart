...
class WinScreen extends StatefulWidget {
  ...
  WinScreen(this.categoryName, this.categoryID, this.quizName, this.level, this.finalScore, this.maxLevel, this.user, this.points);
...
class WinScreenState extends State<WinScreen> {
  ...
  Widget build(BuildContext context) {
    return isLoading ? Loader() : (widget.level == widget.maxLevel
        ? (widget.user.user_name != "Guest" ? WillPopScope(
                ...
                RaisedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                          new QuizLayout(widget.categoryName, widget.categoryID, "Level " + (widget.level+1).toString(), widget.level + 1, widget.maxLevel, widget.user)),
                    );
                  },
                ),
                RaisedButton(
